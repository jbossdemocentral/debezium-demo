...
. Open a new browser tab and go to the link:{openshift-console-url}[topology view]
+
[NOTE]
====
...
% Reached end of topic dbserver-mysql.inventory.customers [0] at offset 4
----
+
[NOTE]
====
...
- link:https://access.redhat.com/documentation/en-us/red_hat_integration/2020-Q2/html-single/installing_change_data_capture_on_openshift/[Installing Debezium on OpenShift]
- link:https://access.redhat.com/documentation/en-us/red_hat_integration/2020-Q2/html-single/installing_change_data_capture_on_rhel/[Installing Debezium on RHEL]
====
